                    ...
                    <form action="{{ route('app.candidate.update', $candidate->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="image" id="image"
                                class="form-control @error('image') is-invalid @enderror" value="{{ old('name', $candidate->image) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="chairman" id="chairman"
                                class="form-control @error('chairman') is-invalid @enderror" value="{{ old('name', $candidate->chairman) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vice_chairman" id="vice_chairman"
                                class="form-control @error('vice_chairman') is-invalid @enderror" value="{{ old('name', $candidate->vice_chairman) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="vision" id="vision"
                                class="form-control @error('vision') is-invalid @enderror"  value="{{ old('name', $candidate->vision) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mission" id="mission"
                                class="form-control @error('mission') is-invalid @enderror"  value="{{ old('name', $candidate->mission) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sort_order" id="sort_order"
                                class="form-control @error('sort_order') is-invalid @enderror"  value="{{ old('name', $candidate->sort_order) }}"
